contract_abi = [
	...
	{
		"inputs": [],
		"name": "bjustCoinTransferOwnership",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract TBjustcoin",
				"name": "",
				"type": "address"
			}
		],
		...
		"outputs": [
			{
				"components": [
					...
					{
						"internalType": "uint8",
						"name": "unlockTokensPercent",
						"type": "uint8"
					}
				],
				"internalType": "struct TokenomicSetting",
				"name": "",
				"type": "tuple"
			}
		],
