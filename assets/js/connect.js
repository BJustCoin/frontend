window.addEventListener('load', function () {   
    ...
    "type": "function"
				...
				my_balance = contract.methods.balanceOf(user_account).call().then(function (a) {
                    console.log("bjustcoin my_balance", a);
                });

                try{
                    balance_span = this.document.body.querySelector(".get_balance");
                    address_span = this.document.body.querySelector(".get_metamask_address");
